...
import { needsTieBreak } from "@shared/domain"
...
async function completeEnd() {
  ...
  if (store.match && needsTieBreak(store.match)) {
  ...
  <section v-if="store.match && store.timers" class="page match-page">
    ...
    <div class="match-grid">
      ...
      <div class="central-actions">
        ...
        <button type="button" class="danger-action" @click="completeEnd">Отправить энд</button>
